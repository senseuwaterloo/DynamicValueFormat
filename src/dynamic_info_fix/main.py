...
from dynamic_info_fix import dynamic_based_df_generate, preprocess, value_format_generate
...
if __name__ == "__main__":
    ...
    # output_file_structured = '../../Output/dynamic_extract/structured_file/Apache_dynamic_structured.csv'
    # output_file_preprocessed = '../../Output/dynamic_extract/preprocessed/Apache_dynamic_preprocessed.csv'
    ...
    dynamic_based_df = dynamic_based_df_generate(new_structured_df, new_template_list_with_dynamic, extract_from_file=False)
    dynamic_based_updated_df = preprocess(dynamic_based_df, template_dynamic_dict)
    print('Finish dynamic based data generation')
    # dynamic_based_updated_df[['Template', 'ParameterIndex', 'Tokens', 'TokenFormat', 'ValueList', 'ValueType']].to_csv(output_file_preprocessed)
